    ...
    <div className="border-t" style={{ borderColor: "hsl(var(--sidebar-border))" }}>
      ...
      <div className="mx-3 mb-2 px-3 py-2.5 rounded-lg" style={{ backgroundColor: "hsl(var(--sidebar-accent))", border: "1px solid hsl(var(--sidebar-border))" }}>
        ...
        <div className="grid grid-cols-3 gap-1">
          ...
          <a href="https://instagram.com/agendaplay" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-1 text-[10px] py-1.5 rounded hover:opacity-80 transition-opacity" style={{ color: "hsl(var(--sidebar-foreground) / 0.8)" }}>
